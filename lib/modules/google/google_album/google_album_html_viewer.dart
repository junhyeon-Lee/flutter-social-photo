...
class GoogleAlbumHtmlViewer extends StatelessWidget {
  const GoogleAlbumHtmlViewer({super.key});
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              height: 50,
                              decoration: const BoxDecoration(color: Colors.grey, borderRadius: BorderRadius.all(Radius.circular(20))),
                              child: Center(child: Text('${controller.selectedIndex + 1}/${controller.albumData!.mediaItems!.length}')),
                            ),
                            const SizedBox(
                              width: 20,
                            ),
                            GestureDetector(
                              onTap: () async {
                                if (controller.selectedIndex != controller.albumData!.mediaItems!.length - 1) {
                                  controller.selectedIndex++;
